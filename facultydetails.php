				...
				<div class="card border border-dark mt-2 ">
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							$result =  mysqli_query($con,"SELECT faculty.name,faculty.designation,course.course_name,faculty.contact,faculty.email FROM faculty,course,teaches,subject WHERE subject.semester = $sem AND subject.course_code = course.course_code AND teaches.course_code = subject.course_code AND faculty.faculty_id = teaches.faculty_id");
